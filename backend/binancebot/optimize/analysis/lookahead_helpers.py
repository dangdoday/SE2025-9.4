...
from binancebot.optimize.analysis.lookahead import LookaheadAnalysis
from binancebot.resolvers import StrategyResolver
from binancebot.util import get_dry_run_wallet, print_rich_table
        ...
        if lookaheadAnalysis_instances:
            ...
            if any(
                ...
                caption = (
                    ...
                    "set_AIML_targets() can be ignored."
                )
