...
from binancebot.constants import BACKTEST_BREAKDOWNS, DATETIME_PRINT_FORMAT
...
from binancebot.util import decimals_per_coin, fmt_coin, format_duration, get_dry_run_wallet
...
def generate_strategy_stats(
    ...
    strat_stats = {
        ...
        "AIMLmodel": config.get("AIMLmodel", None),
        "AIML_identifier": config.get("AIML", {}).get("identifier", None),
