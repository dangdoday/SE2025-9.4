...
AVAILABLE_CLI_OPTIONS = {
    ...
    "AIMLmodel": Arg(
        "--AIMLmodel",
        help="Specify a custom AIMLmodels.",
        metavar="NAME",
    ),
    "AIMLmodel_path": Arg(
        "--AIMLmodel-path",
        help="Specify additional lookup path for AIMLmodels.",
        metavar="PATH",
    ),
    "AIML_backtest_live_models": Arg(
        "--AIML-backtest-live-models", help="Run backtest with ready models.", action="store_true"
    ),
