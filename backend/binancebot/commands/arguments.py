...
from binancebot.commands.cli_options import AVAILABLE_CLI_OPTIONS
from binancebot.constants import DEFAULT_CONFIG
...
ARGS_LIST_AIMLMODELS = ["AIMLmodel_path", "print_one_column"]
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="binancebot", description="Crypto Trading Bot for Binance"
        )
        self._build_args(optionlist=ARGS_MAIN, parser=self.parser)

        from binancebot.commands import (
        ...
        edge_cmd = subparsers.add_parser(
            "edge",
            help="Edge module. No longer part of BinanceBot",
        ...
        # Add list-AIML Models subcommand
        list_AIMLmodels_cmd = subparsers.add_parser(
            "list-AIMLmodels",
            help="Print available AIML models.",
            parents=[_common_parser],
        )
        list_AIMLmodels_cmd.set_defaults(func=start_list_AIML_models)
        self._build_args(optionlist=ARGS_LIST_AIMLMODELS, parser=list_AIMLmodels_cmd)
