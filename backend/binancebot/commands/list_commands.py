...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from binancebot.loggers.rich_console import get_rich_console
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for BinanceBot ({len(available_exchanges)} exchanges):"
...
def start_list_strategies(args: dict[str, Any]) -> None:
    ...
    from binancebot.resolvers import StrategyResolver
    from binancebot.strategy.hyper import detect_all_parameters
...
def start_list_AIML_models(args: dict[str, Any]) -> None:
    """
    Print files with AIML models custom classes available in the directory
    """
    from binancebot.configuration import setup_utils_configuration
    ...
    model_objs = AIMLModelResolver.search_all_objects(config, not args["print_one_column"])
    # Sort alphabetically
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from binancebot.configuration import setup_utils_configuration
    from binancebot.exchange import market_is_active
    from binancebot.misc import plural, safe_value_fallback
    from binancebot.resolvers import ExchangeResolver
    from binancebot.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from binancebot.configuration import setup_utils_configuration
    from binancebot.misc import parse_db_uri_for_logging
    from binancebot.persistence import Trade, init_db
