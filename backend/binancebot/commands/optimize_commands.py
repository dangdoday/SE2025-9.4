...
from binancebot.exceptions import ConfigurationError, OperationalException
...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from binancebot.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting binancebot in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from binancebot.data.btanalysis import load_backtest_stats
    from binancebot.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    try:
        ...
        from binancebot.optimize.hyperopt import Hyperopt
    ...
    logger.info("Starting binancebot in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of binancebot Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help binancebot to exit
...
def start_lookahead_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from binancebot.configuration import setup_utils_configuration
    from binancebot.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from binancebot.configuration import setup_utils_configuration
    from binancebot.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
