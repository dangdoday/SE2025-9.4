...
def start_hyperopt_list(args: dict[str, Any]) -> None:
    ...
    from binancebot.data.btanalysis import get_latest_hyperopt_file
    from binancebot.optimize.hyperopt.hyperopt_output import HyperoptOutput
    from binancebot.optimize.hyperopt_tools import HyperoptTools
...
def start_hyperopt_show(args: dict[str, Any]) -> None:
    ...
    from binancebot.data.btanalysis import get_latest_hyperopt_file
    from binancebot.optimize.hyperopt_tools import HyperoptTools
    from binancebot.optimize.optimize_reports import show_backtest_result
