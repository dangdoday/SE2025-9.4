"""
BinanceBot is the main module of this bot. It contains the BinanceBot class.
"""
...
from binancebot.configuration import remove_exchange_credentials, validate_config_consistency
from binancebot.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from binancebot.data.converter import order_book_to_dataframe
...
from binancebot.exchange.exchange_types import CcxtOrder
# from binancebot.leverage.liquidation_price import update_liquidation_prices  # Module not available
from binancebot.misc import safe_value_fallback, safe_value_fallback2
from binancebot.mixins import LoggingMixin
from binancebot.persistence import Order, PairLocks, Trade, init_db
from binancebot.persistence.key_value_store import set_startup_time
...
from binancebot.rpc import RPCManager
from binancebot.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from binancebot.util import FtPrecise, MeasureTime, PeriodicCache, dt_from_ts, dt_now
from binancebot.util.migrations import migrate_live_content
...
class BinanceBot(LoggingMixin):
    """
    BinanceBot is the main class of the bot.
