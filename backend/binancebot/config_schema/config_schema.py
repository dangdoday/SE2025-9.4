...
from binancebot.enums import RPCMessageType
...
CONF_SCHEMA = {
    ...
    "properties": {
        ...
        "AIML": {
            "description": "AIML configuration.",
            "$ref": "#/definitions/AIML",
        },
    ...
    "definitions": {
        ...
        "AIML": {
            ...
            "properties": {
                "enabled": {
                    "description": "Whether AIML is enabled.",
                    "type": "boolean",
                    "default": False,
                },
                "identifier": {
                ...
                "override_exchange_check": {
                    "description": (
                        "Override the exchange check to force AIML to use exchanges "
                        "that may not have enough historic data. Turn this to True if "
                        "you know your AIML model and strategy do not require historical data."
                    ),
                    "type": "boolean",
                    "default": False,
                },
                    ...
                    "properties": {
                        ...
                        "label_period_candles": {
                            "description": (
                                ...
                                "This can be used in `set_AIML_targets()`."
                            ),
                            "type": "integer",
                        },
