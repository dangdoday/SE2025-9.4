...
from binancebot.configuration.deprecated_settings import process_temporary_deprecated_settings
from binancebot.configuration.directory_operations import create_datadir, create_userdata_dir
from binancebot.configuration.environment_vars import environment_vars_to_dict
from binancebot.configuration.load_config import load_file, load_from_files
...
from binancebot.loggers import setup_logging
from binancebot.misc import deep_merge_dicts, parse_db_uri_for_logging, safe_value_fallback
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from binancebot.commands.arguments import NO_CONF_ALLOWED
        ...
        self._process_AIML_options(config)

        # Import check_exchange here to avoid import cycle problems
        from binancebot.exchange.check_exchange import check_exchange
    ...
    def _process_optimize_options(self, config: Config) -> None:
        ...
        configurations = [
            ...
            ("AIML_backtest_live_models", "Parameter --AIML-backtest-live-models detected ..."),
    ...
    def _process_AIML_options(self, config: Config) -> None:
        self._args_to_config(
            config, argname="AIMLmodel", logstring="Using AIMLmodel class name: {}"
        )

        self._args_to_config(
            config, argname="AIMLmodel_path", logstring="Using AIMLmodel path: {}"
        )
