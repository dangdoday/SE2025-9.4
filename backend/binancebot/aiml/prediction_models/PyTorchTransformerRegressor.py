...
from binancebot.aiml.base_models.BasePyTorchRegressor import BasePyTorchRegressor
from binancebot.aiml.data_kitchen import AIMLDataKitchen
from binancebot.aiml.torch.PyTorchDataConvertor import (
    DefaultPyTorchDataConvertor,
    PyTorchDataConvertor,
)
from binancebot.aiml.torch.PyTorchModelTrainer import PyTorchTransformerTrainer
from binancebot.aiml.torch.PyTorchTransformerModel import PyTorchTransformerModel


class PyTorchTransformerRegressor(BasePyTorchRegressor):
    """
    This class implements the fit method of IAIMLModel.
    ...
    parameters are passed via `model_training_parameters` under the AIML
    ...
    def __init__(self, **kwargs) -> None:
        ...
        config = self.aiml_info.get("model_training_parameters", {})
        self.learning_rate: float = config.get("learning_rate", 3e-4)
        self.model_kwargs: dict[str, Any] = config.get("model_kwargs", {})
        self.trainer_kwargs: dict[str, Any] = config.get("trainer_kwargs", {})

    def fit(self, data_dictionary: dict, dk: AIMLDataKitchen, **kwargs) -> Any:
        """
    ...
    def predict(
        self, unfiltered_df: pd.DataFrame, dk: AIMLDataKitchen, **kwargs
