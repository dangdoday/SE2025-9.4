"""
This module contains class to manage RPC communications (API, ...)
"""
...
from binancebot.enums import NO_ECHO_MESSAGES, RPCMessageType
from binancebot.rpc import RPC, RPCHandler
...
class RPCManager:
    """
    Class to manage RPC objects (API, ...)
    """

    def __init__(self, binancebot) -> None:
        """Initialize all registered RPC modules."""
        self.registered_modules: list[RPCHandler] = []
        self._rpc = RPC(binancebot)
        config = binancebot.config
